...
2)Changing my repository name was more of a challenge than expected. I couldn't get git desktop to recognize the online repo. Finally ended up starting a new repo, new project and new Rmd and got everything to work with versioon control.
...
5)Took me a little bit to figure out hoow to cloone my peers repositories and link them to git in order to leave my comments.